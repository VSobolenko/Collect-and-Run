...
public class InformedText : MonoBehaviour
{
    ...
    [Header("Settings")] [SerializeField] private float _duration = 2f;
    [Range(0f, 1f)] [SerializeField] private float _alphaStartToEndRatio = 0.3f;
    [Range(0f, 1f)] [SerializeField] private float _alphaDurationRatio = 0.5f;
    [Range(0f, 1f)] [SerializeField] private float _scaleLiftingRatio = 0.1f;
